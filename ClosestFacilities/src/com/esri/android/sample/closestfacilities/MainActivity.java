...
public class MainActivity extends Activity {
    ...
    //String queryUrl = "http://sampleserver6.arcgisonline.com/arcgis/rest/services/Recreation/FeatureServer/0/query?where=1%3D1&objectIds=&time=&geometry=%7B%0D%0A%22points%22+%3A+%5B+%5B-117.164183%2C+32.714117%5D%2C+%5B-117.156243%2C+32.706624%5D+%5D%0D%0A%7D&geometryType=esriGeometryMultipoint&inSR=4326&spatialRel=esriSpatialRelEnvelopeIntersects&returnGeometry=true&&outSR=102100&returnIdsOnly=false&returnCountOnly=false&returnZ=false&returnM=false&f=pjson";
    String queryUrl ="http://sampleserver6.arcgisonline.com/arcgis/rest/services/Recreation/FeatureServer/0/query?where=1%3D1&objectIds=&time=&geometry=-117.165183%2C32.724117%2C-117.1056243%2C32.76624&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&relationParam=&outFields=&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=&gdbVersion=&returnDistinctValues=false&returnIdsOnly=false&returnCountOnly=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&returnZ=false&returnM=false&multipatchOption=&f=pjson";
		...
		protected void onPostExecute(ClosestFacilityResult result) {
			...
			if (result == null && auth == true) {
				...
				PictureMarkerSymbol destinationSymbol = new PictureMarkerSymbol(mMapView.getContext(), 
						getResources()
								.getDrawable(R.drawable.route_destination));
