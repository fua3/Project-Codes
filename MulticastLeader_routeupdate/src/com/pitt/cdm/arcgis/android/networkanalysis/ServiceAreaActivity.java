...
public class ServiceAreaActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.servicearea_main);
	...
	class SolveServiceArea extends AsyncTask<Point, Void, ServiceAreaResult> {
		...
		protected void onPreExecute(){
			dialog = ProgressDialog.show(ServiceAreaActivity.this, "", "Solving Service Area Task");
		}
		...
		protected ServiceAreaResult doInBackground(Point... params) {
			...
			try {
				...
				ServiceAreaTask sat = new ServiceAreaTask(
						ServiceAreaActivity.this.getResources().getString(R.string.naservice_url),
						null);
		...
		protected void onPostExecute(ServiceAreaResult result) {
			...
			if(saResult != null){
				...
				alertDialogBuilder = new AlertDialog.Builder(ServiceAreaActivity.this);
				alertDialogBuilder.setTitle("Query Response");
				alertDialogBuilder.setMessage(ServiceAreaActivity.this.getResources().getString(R.string.sa_null_response));
