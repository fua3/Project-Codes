...
public class RoutingtoshelterShowDirections extends ListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Sets the list to the list of directions
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.route_list_item, directions);
